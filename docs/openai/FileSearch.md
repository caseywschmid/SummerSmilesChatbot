...
||
|✅ Responses❌ Chat Completions✅ Assistants|Tier 1100 RPMTier 2 and 3500 RPMTier 4 and 51000 RPM|💰 Pricing🔒 ZDR and data residencyProjects are limited to a total size of 100GB for all FilesVector stores are limited to a total of 10k filesIndividual files can be a max of 512MB (roughly 5M tokens per file)|
